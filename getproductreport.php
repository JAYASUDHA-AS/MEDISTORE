...
<div style="display: flex; justify-content: space-between;">
    <h2 style="color: black; padding-left: 100px; padding-top:50px; align-self: flex-start;">Abirami Medicals</h1>
    <h2 style="color: black; padding-right: 100px; align-self: flex-end;">12-05-23</h2>
</div>
