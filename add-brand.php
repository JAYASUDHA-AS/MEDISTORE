                            ...
                            <div class="card-body">
                                <div class="input-states">
                                   ...
                                   <input type="hidden" name="currnt_date" class="form-control">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Manufacturer Email</label>
                                                <div class="col-sm-9">
                                                  <input type="email"  class="form-control"id="brandEmail" placeholder="Manufacturer Email" name="brandEmail"  required="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="tel"  class="form-control"id="brandNo" placeholder="Contact Number" name="brandNo"  required="" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
